...
public class Purify {
	public static void main(String[] args) {
		...
		String fileName = "/Users/lingyang/Downloads/tomcat_log.txt";
		...
		try {
			...
			while ((line = bufferedReader.readLine()) != null) {
				...
				db.getCollection("logs").insertOne(new Document().append("ip", ip)
						.append("date", matcher.group(1)).append("time", matcher.group(2))
						.append("method", method.substring(1)).append("url", url)
